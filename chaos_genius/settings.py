...
MAX_DEEPDRILLS_SLACK_DAYS = int(os.getenv('MAX_DEEPDRILLS_SLACK_DAYS', default=5))
MAX_ANOMALY_SLACK_DAYS = int(os.getenv('MAX_ANOMALY_SLACK_DAYS', default=5))
ITERATIVE_DAYS_ON_INITIAL_BATCH_TRAINING = int(os.getenv("ITERATIVE_DAYS_ON_INITIAL_BATCH_TRAINING", default=10))
