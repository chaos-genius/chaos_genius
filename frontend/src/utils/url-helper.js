...
export const DATA_SOURCE_LIST_FOR_FILTER = `${BASE_URL}/api/connection/used-types`;
export const DASHBOARD_LIST_FOR_FILTER = `${BASE_URL}/api/dashboard/names`;
export const ALERT_CHANNEL_FOR_FILTER = `${BASE_URL}/api/alert/used-channel-types`;
export const ALERT_STATUS_FOR_FILTER = `${BASE_URL}/api/alert/used-status-types`;
